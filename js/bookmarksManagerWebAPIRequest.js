...
function webAPI_getBookmarksFiltered( successCallBack, errorCallBack) {
...
function webAPI_getBookmarksNameFiltered (successCallBack, nameString, errorCallBack) {
    $.ajax({
        url: apiBaseURL+ "?name="+ nameString +"*",
        type: 'GET',
        contentType:'text/plain',
        data:{},
        success: bookmarks => {  
